  ...
  <?php 
              ...
              <div class="col-md-12">
                  <div class="box box-default">
                    <div class="box-body">
                      ...
                      Anda belum mempunyai nasabah yang ditambahkan ke daftar nasabah Anda.
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="box-header">
      ...
      <div class="box-body">
        ...
        <td><?=$row->alamat?></td>
        <td>
      <a href="#" class="btn btn-success" data-toggle="modal"><i class="fa fa-check"></i> Sudah ditambahkan  </a>
