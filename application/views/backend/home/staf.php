                  ...
                  <?php 
                    ...
                    if (isset($user)) { 
                      foreach ($user as $row ) { ?>
                          ...
                          <p class="text-muted text-center"><?php echo $row->id_staf; ?></p>
                          ...
                          <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                              <b>Telepon</b> <a class="pull-right"><?php echo $row->telepon; ?></a>
                            </li>
                          </ul>

                          <a href="#modalEditBarang<?php echo $row->id_staf?>" class="btn btn-primary btn-block" data-toggle="modal">
...
if (isset($user)){
    foreach($user as $row2){
        ?>
        <div id="modalEditBarang<?php echo $row2->id_staf?>" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           <div class="modal-dialog">
           <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 id="myModalLabel">Edit Data Staff</h3>
            </div>
              ...
              <form class="form-horizontal" method="post" action="<?php echo site_url('Data_control/update_staf/')?>">
                  <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input class="form-control" name="kd_staf" type="text" value="<?php echo $row2->id_staf;?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input class="form-control" name="kd_email" type="text" value="<?php echo $row2->email;?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                          <input class="form-control" name="kd_telepon" type="text" value="<?php echo $row2->telepon;?>">
                        </div>
                    </div>
